...
// TV Shows Data
let shows = [
  { name: "Game of Thrones", genre: "Drama" },
  { name: "Breaking Bad", genre: "Crime" },
  { name: "Friends", genre: "Comedy" },
  { name: "Arrow", genre: "Action" },
  { name: "Stranger Things", genre: "Sci-Fi" }
];

// Users Data (5 users required)
let users = [
  { name: "John Doe", email: "john@gmail.com", password: "Abc@1234" },
  { name: "Jane Smith", email: "jane@gmail.com", password: "Xyz@5678" },
  { name: "Alex Roy", email: "alex@gmail.com", password: "Pass@123" },
  { name: "Maya Lee", email: "maya@gmail.com", password: "Test@456" },
  { name: "Sam Kim", email: "sam@gmail.com", password: "Code@789" }
];